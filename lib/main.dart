                        ...
                        Row(
                          children: [
                            ...
                            Container(
                                ...
                                child: Text(
                                  '$rating',
                                  style: TextStyle(color: Color(0xff6d6d6c)),
                                )),
                            SizedBox(height: 10),
                          ],
                        ),
            ...
            Column(
              ...
              children: [
                Container(
                    ...
                    decoration: BoxDecoration(color: Color(0xffb2e9f1)),
                    child: Row(
                      children: [
                        SizedBox(width: 4),
                        Padding(
                  ...
                  children: [
                    ...
                    Expanded(
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border.all(
                                  width: 1.2, color: Color(0xffececec)),
                            ),
                ...
                getResult(
                    ...
                    'assets/echo_1.jpg'),
                Container(
                    color: Color(0xfffffeff), child: Text(''), height: 10),
